...
model_name_or_path=$data_root/outputs/pretrain/large_group2_mt_pretrain/checkpoint-1940000
output_dir=$data_root/outputs/finetune/large_group2_mt_pretrain/checkpoint-1940000
...
save_steps=9999999  #useless, see line 119 in run.py
