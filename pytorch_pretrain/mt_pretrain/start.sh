...
model_name_or_path=$data_root/outputs/pretrain/large_group2_wwm/checkpoint-1390000
output_dir=$data_root/outputs/pretrain/large_group2_mt_pretrain
...
logging_steps=20
eval_steps=10000   #500
save_steps=10000     #5000
max_steps=5000000    #1000000  #for testing
